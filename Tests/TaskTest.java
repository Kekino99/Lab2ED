...
public class TaskTest {
    ...
    public void testWithinRange() {
        ...
        assertEquals(Collections.emptyList(), Task.withinRange(Collections.emptyList(), 1L, 2L));
    }
    ...
    public void testCopyWithRange() {
        ...
        Task.copyWithRange(Collections.emptyList(), list3, 1L, 2L);
        assertEquals(Collections.emptyList(), list3);
    ...
    public void testCopyWithTange() {
        ...
        assertEquals(Arrays.asList(2L, 3L, 4L, 13L, 14L), list3);
        list3 = Collections.emptyList();
        Task.copyWithTange(Comparator.naturalOrder(), Collections.emptyList(), list3, 1L, 2L);
        assertEquals(Collections.emptyList(), list3);
